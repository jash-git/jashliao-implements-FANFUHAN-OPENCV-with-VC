// VC_FANFUHAN_OPENCV070.cpp : 定義主控台應用程式的進入點。
//
/*
// Debug | x32
通用屬性
...
int main()
{
	Mat src = imread("../../images/address.jpg");//Mat src = imread("../../images/test.png");
	if (src.empty())
	{
