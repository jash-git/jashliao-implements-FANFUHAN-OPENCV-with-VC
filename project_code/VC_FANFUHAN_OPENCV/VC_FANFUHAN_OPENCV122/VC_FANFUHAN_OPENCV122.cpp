// VC_FANFUHAN_OPENCV122.cpp : 定義主控台應用程式的進入點。
//
/*
// Debug | x32
通用屬性
...
int main()
{
	Mat src1 = imread("C:\\Users\\user\\Desktop\\01.jpg");
	Mat src2 = imread("C:\\Users\\user\\Desktop\\02.jpg");
	...
	else
	{
		...
		// 构建新图像的大小
		int width = max(src1.cols,src2.cols);
		...
		imwrite("C:\\Users\\user\\Desktop\\03.jpg", two);
		pause();
		waitKey(0);
	}
