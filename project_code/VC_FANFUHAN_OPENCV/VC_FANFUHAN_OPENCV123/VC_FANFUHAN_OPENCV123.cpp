// VC_FANFUHAN_OPENCV123.cpp : 定義主控台應用程式的進入點。
//
/*
// Debug | x32
通用屬性
...
//文章: http://opencvexamples.blogspot.com/2014/01/detect-mouse-clicks-and-moves-on-image.html
...
int main()
{
	...
	{
		//Create a window
		namedWindow("input_src", 1);

		//set the callback function for any mouse event
		setMouseCallback("input_src", MouseCallBackFunc, &src);
...
void MouseCallBackFunc(int event, int x, int y, int flags, void* userdata)
{
	if (event == EVENT_LBUTTONDOWN)
	{
		...
		printf("Left button of the mouse is clicked - position (%d,%d):: B:%d, G:%d, R:%d\n",
			x, y,
